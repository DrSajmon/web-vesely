    ...
    <main style={{ maxWidth: '850px', margin: '40px auto', padding: '0 20px' }}>
      <div style={{ backgroundColor: '#fff', padding: '40px', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05)', borderTop: '5px solid #f97316' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
          <div style={{ borderLeft: '5px solid #f97316', paddingLeft: '20px', backgroundColor: '#f8fafc', padding: '20px', borderRadius: '0 8px 8px 0' }}>
          ...
          <div style={{ borderLeft: '5px solid #1e293b', paddingLeft: '20px', backgroundColor: '#f8fafc', padding: '20px', borderRadius: '0 8px 8px 0' }}>
